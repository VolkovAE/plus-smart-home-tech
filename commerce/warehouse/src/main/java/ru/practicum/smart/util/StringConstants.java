...
public final class StringConstants {
    ...
    public static final String COLUMN_NAME_ENTITY_PRODUCT_WIDTH = "width";
    public static final String COLUMN_NAME_ENTITY_PRODUCT_QUANTITY = "quantity";
    public static final String COLUMN_NAME_ENTITY_PRODUCT_WEIGHT = "weight";
    public static final String COLUMN_NAME_ENTITY_PRODUCT_FRAGILE = "fragile";
}
