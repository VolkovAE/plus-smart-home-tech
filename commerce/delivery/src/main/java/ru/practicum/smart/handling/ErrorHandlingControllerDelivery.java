...
public class ErrorHandlingControllerDelivery {
    private static final Logger log = LoggerFactory.getLogger(ErrorHandlingControllerDelivery.class);
    ...
    public ValidationErrorResponse onNotFoundServiceException(NotFoundServiceException e) {
        Violation violation = new Violation("-", e.getMessage());
        List<Violation> violationList = List.of(violation);
    ...
    public ValidationErrorResponse onServiceTemporarilyUnavailableException(ServiceTemporarilyUnavailableException e) {
        Violation violation = new Violation("-", e.getMessage());
        List<Violation> violationList = List.of(violation);
